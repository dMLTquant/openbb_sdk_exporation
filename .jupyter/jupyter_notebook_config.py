...
c = get_config()  # noqa
c.MultiKernelManager.default_kernel_name = 'obb'
c.MappingKernelManager.default_kernel_name = 'obb'
c.AsyncMultiKernelManager.default_kernel_name = 'obb'
c.AsyncMappingKernelManager.default_kernel_name = 'obb'
c.GatewayKernelManager.default_kernel_name = 'obb'
...
#  Choices: any of ['md5', 'sha3_224', 'sha512', 'sha3_256', 'sha3_512', 'sha224', 'blake2s', 'sha256', 'blake2b', 'sha3_384', 'sha384', 'sha1']
#  Default: 'sha256'
